      ...
      <main id="registration">
        <article className="prose lg:prose-xl">
          ...
          <p className="font-light">
            ...
            using a physical security key. WebAuthn is designed to be resistant
            to phishing attacks and other forms of online fraud, and it provides
            a higher level of security than traditional password-based
          ...
          <blockquote>
            <p className="text-lg">
              ...
              your username, but you don't need to enter a password. Instead,
              you will be asked to use your fingerprint or face to authenticate
              yourself.
            </p>
          </blockquote>
        </article>
      ...
      <main id="authenticator-type">
        ...
        <article className="prose lg:prose-xl">
          ...
          <p className="font-light">
            ...
            they are installed. Cross-platform authenticators are installed on a
            device and can be used on any device that supports WebAuthn.
          </p>
